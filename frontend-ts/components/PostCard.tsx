import React, { useState, useCallback, VFC, memo, forwardRef, ForwardedRef } from 'react';
...
const PostCard: VFC<{ post: IPost; ref: ForwardedRef<HTMLDivElement> }> = memo(
  forwardRef<HTMLDivElement, { post: IPost }>(({ post }, ref) => {
    return (
      <div
        ref={ref}
        css={css`
